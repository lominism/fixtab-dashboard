...
(()=>{
    const e = new Error("Cannot find module '@/data/branches.json'");
...
;
function Branches() {
    const [branches, setBranches] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(branchesData);
...
//# sourceMappingURL=src_655625d6._.js.map